    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form autocomplete="off" @submit.prevent="createTransation">
            <!-- Valor da transação -->
            <div class="input-box">
            ...
            <div class="input-box">
              ...
              <select v-model="tipo" id="tipo" name="tipo" class="text-reset">
                <option value="" disabled selected>Tipo da transação</option>
...
export default {
  setup() {
    ...
    return {
      ...
      addTransacao: (transacao) => store.dispatch("addTransacao", transacao),
    };
  },
  data() {
    return {
  ...
  methods: {
    async createTransation() {
      ...
      await this.addTransacao(transacao);
      this.getTransacoes();
